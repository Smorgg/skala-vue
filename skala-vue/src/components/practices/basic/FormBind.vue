...
<template>
    <div class="practice-section">
        ...
        <div>
            ...
            <label><input type="checkbox" value="사과" v-model="favoriteFruites" />사과</label> &nbsp;
            <label><input type="checkbox" value="바나나" v-model="favoriteFruites" />바나나</label> &nbsp;
            <label><input type="checkbox" value="딸기" v-model="favoriteFruites" />딸기</label>
            <p>
                데이터 상태 (배열): <span>{{ favoriteFruites }}</span>
            </p>
        </div>
        <div>
            <h3>4) Radio (단일 선택)</h3>
